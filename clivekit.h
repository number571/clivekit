...
extern clivekit_error_type clivekit_set_rx_key_to_room(char* room_desc, char* ident, char* rx_key);
extern clivekit_error_type clivekit_set_tx_key_to_room(char* room_desc, char* tx_key);
